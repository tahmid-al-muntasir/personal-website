exports.id=336,exports.ids=[336],exports.modules={4872:(e,t,a)=>{Promise.resolve().then(a.t.bind(a,2994,23)),Promise.resolve().then(a.t.bind(a,6114,23)),Promise.resolve().then(a.t.bind(a,9727,23)),Promise.resolve().then(a.t.bind(a,9671,23)),Promise.resolve().then(a.t.bind(a,1868,23)),Promise.resolve().then(a.t.bind(a,4759,23))},5678:(e,t,a)=>{Promise.resolve().then(a.t.bind(a,9404,23))},8088:(e,t,a)=>{Promise.resolve().then(a.bind(a,8731)),Promise.resolve().then(a.bind(a,8814))},8731:(e,t,a)=>{"use strict";a.d(t,{default:()=>c});var i=a(326),n=a(7577),r=a(434),s=a(5047),o=a(3269);let l=[{href:"/",label:"Home"},{href:"/research",label:"Research"},{href:"/projects",label:"Projects"},{href:"/papers",label:"Papers"},{href:"/blog",label:"Blog"},{href:"/media",label:"Media"},{href:"/now",label:"Now"},{href:"/contact",label:"Contact"}];function c(){let e=(0,s.usePathname)(),[t,a]=(0,n.useState)(!1);return(0,i.jsxs)(i.Fragment,{children:[i.jsx("header",{className:"top-nav","data-reveal":!0,children:(0,i.jsxs)("div",{className:"top-nav-inner",children:[(0,i.jsxs)(r.default,{href:"/",className:"nav-brand",children:[i.jsx("span",{className:"brand-mark",children:"TAM"}),(0,i.jsxs)("span",{className:"nav-brand-copy",children:[i.jsx("span",{className:"label",children:"Tahmid Al Muntasir"}),i.jsx("span",{className:"nav-subline",children:"Textile Engineering \xd7 AI"})]})]}),i.jsx("nav",{className:"nav-links nav-links-desktop","aria-label":"Main",children:l.map(({href:t,label:a})=>{let n=e===t||"/"!==t&&e.startsWith(t);return i.jsx(r.default,{href:t,className:`nav-link ${n?"is-active":""}`,children:a},t)})}),(0,i.jsxs)("div",{className:"nav-meta nav-meta-desktop",children:[i.jsx("a",{href:o.JA.links.github,target:"_blank",rel:"noopener noreferrer",className:"label link-inline","aria-label":"GitHub (opens in new window)",children:"GitHub ↗"}),i.jsx("a",{href:o.JA.links.linkedin,target:"_blank",rel:"noopener noreferrer",className:"label link-inline","aria-label":"LinkedIn (opens in new window)",children:"LinkedIn ↗"}),i.jsx("a",{href:o.JA.links.cv,title:"CV coming soon",target:"_blank",rel:"noopener noreferrer",className:"label link-inline","aria-label":"Download CV (opens in new window)",children:"CV ↗"})]}),i.jsx("button",{onClick:()=>a(!t),className:"nav-toggle","aria-expanded":t,"aria-label":t?"Close navigation menu":"Open navigation menu",children:t?"CLOSE":"MENU"})]})}),t&&(0,i.jsxs)("div",{className:"nav-drawer",children:[i.jsx("nav",{className:"nav-drawer-links",children:l.map(({href:t,label:n})=>i.jsx(r.default,{href:t,onClick:()=>a(!1),className:`nav-drawer-link ${e===t?"is-active":""}`,children:n},t))}),(0,i.jsxs)("div",{className:"nav-drawer-meta",children:[i.jsx("a",{href:o.JA.links.github,target:"_blank",rel:"noopener noreferrer",className:"label link-inline","aria-label":"GitHub (opens in new window)",children:"GitHub ↗"}),i.jsx("a",{href:o.JA.links.linkedin,target:"_blank",rel:"noopener noreferrer",className:"label link-inline","aria-label":"LinkedIn (opens in new window)",children:"LinkedIn ↗"}),i.jsx("a",{href:o.JA.links.cv,title:"CV coming soon",target:"_blank",rel:"noopener noreferrer",className:"label link-inline","aria-label":"Download CV (opens in new window)",children:"CV ↗"})]})]})]})}},8814:(e,t,a)=>{"use strict";function i(){return null}a.d(t,{default:()=>i}),a(7577)},3269:(e,t,a)=>{"use strict";a.d(t,{JA:()=>i,MN:()=>n,b8:()=>s,q:()=>r,xu:()=>o});let i={name:"Tahmid Al Muntasir",initials:"TAM",tagline:"Textile Engineering \xd7 AI",subtitle:"Machine Learning \xb7 Computer Vision \xb7 Robotics",description:"Final-year engineering student building rigorous, deployment-minded systems at the intersection of textile engineering, machine learning, computer vision, and robotics.",location:"Bangladesh \uD83C\uDDE7\uD83C\uDDE9",email:"tahmid@example.com",links:{github:"https://github.com/tahmid-al-muntasir",linkedin:"https://linkedin.com/in/tahmid-al-muntasir",kaggle:"https://www.kaggle.com/tahmidalmuntasir",leetcode:"https://leetcode.com/tahmidalmuntasir",twitter:"",cv:"/cv.pdf"},forms:{formspreeId:process.env.NEXT_PUBLIC_FORMSPREE_ID??""},status:"Open to PhD Opportunities \xb7 2026",quote:'"The best research solves real problems." — TAM'},n=[{id:"p1",num:"01",label:"Pillar 1",title:"AI-Driven Smart Thermal Garments",shortTitle:"Smart Thermal Garments",phase:"Active — Thesis Track",color:"rust",summary:"Bio-based PCM thermal regulation with hybrid control, edge deployment, and comfort-aware sensing.",description:"Designing a thermal garment that fuses body sensing, physics-based modeling, and hybrid control. The system explores bio-based PCM layers, predictive thermal regulation, and ESP32-class deployment for a battery-light wearable platform.",problems:["2D thermal modeling","PCM phase-change behavior","MPC baseline","TinyML deployment","Comfort-aware control"],stack:["ESP32","PCM","PyTorch","SciPy","MPC"],target:"IEEE Transactions on Industrial Electronics",paperTitle:"Hybrid Control for AI-Driven Smart Thermal Garments with Bio-Based PCM"},{id:"p2",num:"02",label:"Pillar 2",title:"Real-Time CV for Fabric Defect Detection",shortTitle:"Fabric Defect Detection",phase:"Active — Applied Vision",color:"amber",summary:"Production-ready defect detection for textile quality control using computer vision.",description:"Building a real-time computer vision pipeline for textile inspection with YOLOv8. Focus: robust detection under changing factory lighting, fast inference, and practical QA workflows.",problems:["Fabric defect dataset creation","YOLOv8 training","Runtime optimization","Lighting robustness","Deployment workflow"],stack:["YOLOv8","PyTorch","OpenCV","Roboflow","ESP32"],target:"CVPR Workshop on Vision for Manufacturing",paperTitle:"Real-Time Fabric Defect Detection for Textile Quality Assurance"},{id:"p3",num:"03",label:"Pillar 3",title:"RL for Robotic Fabric Manipulation",shortTitle:"Robotic Fabric Manipulation",phase:"Active — Robotics Track",color:"sage",summary:"Simulation-first reinforcement learning for textile handling and robot policy learning.",description:"Exploring reinforcement learning policies for robotic fabric manipulation, with an emphasis on simulation environments, motion planning, and policy transfer from Gazebo to real-world systems.",problems:["Policy learning","ROS integration","Gazebo simulation","Grasp stability","Sim-to-real transfer"],stack:["ROS","Gazebo","PyTorch","RL","Computer Vision"],target:"ACL Findings",paperTitle:"Reinforcement Learning for Robotic Fabric Manipulation in Simulation"}],r=[{id:"etextile-control",pillar:"P1",pillarColor:"rust",phase:"Thesis Track",title:"AI-Driven Smart Thermal Garments",description:"A wearable control stack that combines bio-based PCM, thermal sensing, and hybrid predictive control for adaptive comfort regulation.",status:"active",github:"https://github.com/tahmid-al-muntasir/etextile-control",demo:"",stack:["PCM","ESP32","PyTorch","SciPy","MPC"],highlights:["Bio-based PCM thesis in progress","Thermal model refined","Edge deployment path defined"]},{id:"fabric-vision",pillar:"P2",pillarColor:"amber",phase:"Applied Vision",title:"Real-Time CV for Fabric Defect Detection",description:"A fast inspection pipeline for textile defects using YOLO-based detection and production-minded inference workflows.",status:"active",github:"https://github.com/tahmid-al-muntasir/fabric-vision",demo:"",stack:["YOLO","PyTorch","OpenCV","Roboflow","ESP32"],highlights:["Dataset labeling underway","Real-time inference target","Factory deployment constraints mapped"]},{id:"robotic-fabric-manipulation",pillar:"P3",pillarColor:"sage",phase:"Robotics Track",title:"RL for Robotic Fabric Manipulation",description:"Simulation-first reinforcement learning for robot policies that can pick, align, and manipulate textile materials reliably.",status:"active",github:"https://github.com/tahmid-al-muntasir/robotic-fabric-manipulation",demo:"",stack:["ROS","Gazebo","PyTorch","RL","Computer Vision"],highlights:["Simulation environment in progress","Policy design underway","Sim-to-real path planned"]}],s=[{period:"2025–Present",title:"Bio-based PCM thesis",org:"Final-year research",status:"In progress",summary:"Designing and validating the thermal regulation system, from simulation and control baselines to a deployable smart-garment prototype."},{period:"Industrial rotation II",title:"Textile manufacturing rotation",org:"SQUARE Apparels",status:"Completed",summary:"Process observation, production-floor analysis, and the link between textile manufacturing constraints and automation opportunities."},{period:"Industrial rotation I",title:"Textile operations rotation",org:"SQUARE Apparels",status:"Completed",summary:"Hands-on exposure to production systems, quality-control workflows, and the operational realities that shape textile-engineering decisions."}],o=[{slug:"yolov8-fabric-defects",title:"Fine-tuning YOLOv8 for Fabric Defect Detection",date:"2026-04-15",category:"research",pillar:"P2",tags:["YOLOv8","Computer Vision","Manufacturing"],readTime:"8 min",excerpt:"A deep dive into training YOLOv8 on custom fabric defect datasets, including data augmentation strategies and hyperparameter optimization.",content:`
## The Problem
...
The key insight: use MPC as a *constraint layer* for RL. The RL policy proposes actions, MPC clips them to the safe set. Neither system is fully in charge.
    `},{slug:"thermal-simulation-fourier-baseline",title:"Week 1: First Thermal Simulation Results (Fourier's Law Baseline)",date:"2026-04-22",category:"devlog",pillar:"P1",tags:["Thermal Modeling","Simulation","Python"],readTime:"3 min",excerpt:"Initial 1D thermal simulation using Fourier's law. Results, surprises, and what I got wrong on the first try.",content:`
## What I Built
...
Simple Fourier conduction: q = -k \xb7 dT/dx
...
**The PCM layer blew up.** I forgot to handle latent heat. When the PCM hits its melting point (~28\xb0C), it absorbs heat without changing temperature — that requires a separate enthalpy tracking variable, not just Cp.
...
**Next**: extend to 2D, add the TEG power harvesting model, couple to the comfort metric.
    `},{slug:"yolov8-dataset-labeling-week2",title:"Week 2: YOLOv8 Dataset Labeling — 47 Images Done",date:"2026-04-20",category:"devlog",pillar:"P2",tags:["YOLOv8","Dataset","Roboflow"],readTime:"2 min",excerpt:"Progress update on fabric defect dataset creation. Lessons from the first 47 annotations.",content:`
## Current Status
...
**Target**: 500 images by end of May. Then first real training run.
    `},{slug:"cosine-similarity-multilingual-embeddings",title:"Week 2: Cosine Similarity Baselines for Multilingual Embeddings",date:"2026-04-18",category:"devlog",pillar:"P3",tags:["NLP","Embeddings","RAG"],readTime:"3 min",excerpt:"Benchmarking LaBSE and multilingual-E5 on cross-lingual similarity tasks for materials science queries.",content:`
## The Baseline Task
...
docs_de = ["W\xe4rmeleitf\xe4higkeit von Polyesterfasern betr\xe4gt etwa 0.04 W/mK"]
...
**Next**: build the actual FAISS vector store, test on larger corpus.
    `},{slug:"cross-lingual-embeddings-materials-science",title:"Cross-Lingual Embeddings for Materials Science Literature",date:"2026-03-10",category:"research",pillar:"P3",tags:["NLP","Embeddings","RAG","Materials Science"],readTime:"10 min",excerpt:"Evaluating multilingual sentence embeddings for cross-lingual retrieval in materials science research.",content:`
## The Problem
...
Early results suggest: partially. LaBSE handles standard technical vocabulary well. It struggles with domain-specific compounds (German: *W\xe4rmeleitf\xe4higkeitsmessverfahren* — thermal conductivity measurement method).
...
This setup takes a day to set up properly. It saves weeks over a 6-month project.
    `},{slug:"error-pcm-latent-heat",title:"ERROR LOG: PCM Phase Change Blowing Up My Simulation",date:"2026-04-21",category:"devlog",pillar:"P1",tags:["Error","Simulation","Thermal Modeling","Debugging"],readTime:"4 min",excerpt:"Spent 3 hours debugging a thermal sim that was giving plausible-but-wrong results. The fix was embarrassingly simple.",content:`
## The Error
...
Always validate against known analytical solutions before trusting numerical results. For PCM, the Stefan problem has an analytical solution — I should have checked against it on day 1.
    `},{slug:"error-faiss-index-mismatch",title:"ERROR LOG: FAISS Index Dimension Mismatch at 2am",date:"2026-04-16",category:"devlog",pillar:"P3",tags:["Error","FAISS","NLP","Debugging"],readTime:"2 min",excerpt:"Classic mistake. FAISS index built with LaBSE, queried with mE5. Dimension mismatch. 45 minutes lost.",content:`
## The Error Message
...
Name your artifacts. Every saved model file, index, and checkpoint should encode the model name and key hyperparameters. Future you at 2am will thank you.
    `},{slug:"german-month-1-review",title:"German Month 1 Review: What's Working, What Isn't",date:"2026-04-28",category:"language",tags:["German","Language Learning","Anki"],readTime:"5 min",excerpt:"One month into B1 German. Honest assessment of my study methods and the surprises so far.",content:`
## The Plan
...
Target for Month 2: 600 words, Episodes 1–24, first attempt at reading a simple German abstract.
    `},{slug:"japanese-hiragana-done",title:"Japanese: Hiragana Complete — Notes from the First Week",date:"2026-04-10",category:"language",tags:["Japanese","Language Learning","Hiragana"],readTime:"3 min",excerpt:"Finished the hiragana table. Moving to katakana and JLPT N5 vocab. Some observations on learning a non-Latin script.",content:`
## Hiragana: Done
...
Target: N4 by end of year.
    `},{slug:"bellman-equation-intuition",title:"The Bellman Equation is Just a Promise About the Future",date:"2026-04-05",category:"math",tags:["Reinforcement Learning","Math","Intuition"],readTime:"6 min",excerpt:"Everyone learns the Bellman equation as a formula. Here's how I finally understood it as an idea.",content:`
...
The RL agent for thermal regulation has a 30-minute horizon. Every "state" is a temperature profile + time + TEG power level. The Bellman equation says: the value of being at a comfortable 37\xb0C isn't just comfort right now — it's that plus the expected future comfort under optimal control.
...
This is why the horizon matters. Too short: the agent ignores consequences. Too long: the discount factor makes future rewards irrelevant. Getting γ right is not a mathematical choice — it's a statement about how much the system should "care" about the future.
    `},{slug:"why-sim-to-real-is-hard",title:"Why Sim-to-Real Transfer is Genuinely Hard (and Kind of Fascinating)",date:"2026-03-20",category:"math",tags:["Reinforcement Learning","Robotics","Sim-to-Real","Domain Randomization"],readTime:"7 min",excerpt:"The gap between simulation and reality is a distribution shift problem. Here's what makes it fundamentally different from standard out-of-distribution generalization.",content:`
## The Naive View
...
The same principle — design for a distribution of environments, not a single point — appears across RL, control theory, and robust statistics. That's not a coincidence. It's a deep structural property of any system that has to operate in an uncertain world.
    `},{slug:"on-being-a-textile-engineer-doing-ai",title:"On Being a Textile Engineer Doing AI Research",date:"2026-04-25",category:"note",tags:["Reflection","PhD","Career"],readTime:"3 min",excerpt:"People ask why a textile engineer is doing reinforcement learning research. Here's the actual answer.",content:`
...
That's the plan.
    `}]},2362:(e,t,a)=>{"use strict";a.r(t),a.d(t,{default:()=>g,metadata:()=>u});var i=a(9510);a(4315);var n=a(8570);let r=(0,n.createProxy)(String.raw`E:\Life\Website\tam-site\src\components\Nav.jsx`),{__esModule:s,$$typeof:o}=r;r.default;let l=(0,n.createProxy)(String.raw`E:\Life\Website\tam-site\src\components\Nav.jsx#default`),c=(0,n.createProxy)(String.raw`E:\Life\Website\tam-site\src\components\ScrollReveal.jsx`),{__esModule:d,$$typeof:h}=c;c.default;let m=(0,n.createProxy)(String.raw`E:\Life\Website\tam-site\src\components\ScrollReveal.jsx#default`),u={metadataBase:new URL("https://tahmids-website.vercel.app"),title:"Tahmid Al Muntasir | Textile Engineering \xd7 AI",description:"Final-year engineering student building systems at the intersection of textile engineering, machine learning, and robotics.",openGraph:{title:"Tahmid Al Muntasir | Textile Engineering \xd7 AI",description:"Final-year engineering student building systems at the intersection of textile engineering, machine learning, and robotics.",url:"https://tahmids-website.vercel.app",type:"website"},twitter:{card:"summary",title:"Tahmid Al Muntasir | Textile Engineering \xd7 AI",description:"Final-year engineering student building systems at the intersection of textile engineering, machine learning, and robotics."}};function g({children:e}){return(0,i.jsxs)("html",{lang:"en",children:[(0,i.jsxs)("head",{children:[i.jsx("meta",{name:"viewport",content:"width=device-width, initial-scale=1"}),i.jsx("link",{rel:"canonical",href:"https://tahmids-website.vercel.app"}),i.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify({"@context":"https://schema.org","@type":"Person",name:"Tahmid Al Muntasir",url:"https://tahmids-website.vercel.app",sameAs:["https://github.com/tahmid-al-muntasir","https://linkedin.com/in/tahmid-al-muntasir"],jobTitle:"Final-Year Student | AI/ML Engineer",description:"Building rigorous AI systems at the intersection of textile engineering, machine learning, computer vision, and robotics.",knowsAbout:["Machine Learning","Computer Vision","Robotics","Textile Engineering","Reinforcement Learning"]})}})]}),(0,i.jsxs)("body",{children:[i.jsx(m,{}),i.jsx("a",{href:"#main-content",className:"skip-link",children:"Skip to main content"}),i.jsx("div",{className:"site-wrap",children:(0,i.jsxs)("div",{className:"layout-main",children:[i.jsx(l,{}),i.jsx("main",{id:"main-content",className:"content-main page-shell",children:e}),i.jsx("footer",{className:"site-footer",role:"contentinfo",children:i.jsx("div",{className:"footer-content",children:i.jsx("p",{className:"label",children:"\xa9 2026 Tahmid Al Muntasir. Built with Next.js, CSS, and rigor."})})})]})})]})]})}},1837:(e,t,a)=>{"use strict";a.r(t),a.d(t,{default:()=>r});var i=a(9510),n=a(7371);function r(){return(0,i.jsxs)("div",{className:"card not-found","data-reveal":!0,children:[i.jsx("div",{className:"not-found-code",children:"404"}),i.jsx("h2",{children:"Page not found"}),i.jsx("p",{className:"card-copy",children:"This page doesn't exist, or it has not been built yet."}),i.jsx(n.default,{href:"/",className:"button button-secondary",children:"Back to home"})]})}},4315:()=>{}};