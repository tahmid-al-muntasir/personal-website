...
That's the plan.
    `}],l={lastUpdated:"April 2026",location:"Bangladesh \uD83C\uDDE7\uD83C\uDDE9",research:["Building 2D thermal simulation model for PCM textile layers (Pillar 1, Phase 1)","Labeling fabric defect dataset in Roboflow — targeting 500 annotated images (Pillar 2)","Evaluating multilingual embedding models for materials science retrieval (Pillar 3)"],learning:[{flag:"\uD83C\uDDE9\uD83C\uDDEA",label:"German",detail:"Month 1 of B1 track. Nicos Weg + Anki Core 2000."},{flag:"\uD83C\uDDEF\uD83C\uDDF5",label:"Japanese",detail:"Hiragana complete. Beginning JLPT N5 vocab."},{flag:"\uD83C\uDFCB️",label:"Training",detail:"Boxing (Mon), BJJ (Tue), Taekwondo (Wed), Strength (Thu)"},{flag:"\uD83D\uDCDA",label:"Islamic Studies",detail:"Rotating — Aqeedah, Fiqh, Hadith, Tafsir"},{flag:"\uD83D\uDCBB",label:"LeetCode",detail:"NeetCode 150 — Arrays & Hashing module"}],reading:["Art of War — Sun Tzu (Strategic rotation, Week 2)","Muqaddimah — Ibn Khaldun (excerpts)","MIT OCW: Fundamentals of Heat and Mass Transfer (Lectures 1–3)"],buildingToward:["PhD applications: 2026–2027 cycle","GRE prep: Active","IELTS prep: Active","First preprint: Target Month 6"]}}};